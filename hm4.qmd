...
```
# during the log2(lamda) value increase ,the cv accuracy slighly increase. at log2(lamda) approach -7.5 it geting the maxium of cv accuracy. but until log2(lamda) reach -5 and after. the cv accuracy value quickly going down about it. 
